            ...
            <div class="col-lg-3 offset-xl-1 contact_col">
                <div class="contact_info">
                    <div class="contact_info_section">
                        ...
                        <ul>
                            <li>Phone: <span>+380 (96) 861 41 73</span></li>
                            <li>Email: <span>denys.kopylchuk-ip211@nung.edu.ua</span></li>
                        </ul>
                    </div>
                    <div class="contact_info_section">
                        ...
                        <ul>
                            <li>Phone: <span>+380 (96) 861 41 73</span></li>
                            <li>Email: <span>kopylchukdenise@gmail.com</span></li>
                        </ul>
                    </div>
                    <div class="contact_info_section">
                        ...
                        <ul>
                            <li>Phone: <span>+380 (96) 861 41 73</span></li>
                            <li>Email: <span>kopylchykdenys@gmail.com</span></li>
                        </ul>
                    </div>
                </div>
            </div>
